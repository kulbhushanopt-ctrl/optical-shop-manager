      ...
      <div className="w-full max-w-sm">
        <div className="flex flex-col items-center mb-8">
          <div className="bg-focus rounded-full w-[52px] h-[52px] flex items-center justify-center mb-3">
            <ScanEye size={24} className="text-white" strokeWidth={2.2} />
          </div>
          <h1 className="font-display text-xl font-bold text-ink">Scleral Lens Practice</h1>
          <p className="text-xs text-slate mt-1">{mode === "signin" ? "Sign in to your practice" : "Create your practice account"}</p>
        </div>
        ...
        <button
          ...
          className="text-xs font-medium text-focus mt-4 mx-auto block"
        >
