// Reads a photo of a contact/scleral lens prescription or fitting slip
// (printed or handwritten) and extracts the OD/OS power, cylinder, axis,
// base curve, diameter, add-power, and brand values, using a vision-capable
// AI model. Requires a GEMINI_API_KEY secret -- until one is set, this
// responds with { error: "not_configured" } so the frontend can show a
